...
const input_texts={om:"","m":"","siv":'',"n":"","hem":"ant","kum":"ar","dix":"it"}
// const input_texts=[[{"om":"m"},{"siv":"n"}]]
...
export const depth = 2 * radius
 ...
 const SphereARApp: React.FC = React.memo(() => {
...
const text_s: string[] = Object.keys(representations_nakshastra)

export default SphereARApp
