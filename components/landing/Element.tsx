...
const Element_=()=>{
  return <div className="bg-sky-700 p-2 flex flex-row flex-wrap gap-4">
    {
      Object.keys(AT).slice(1).map((atom,index)=>{
        return <div key={index} className=" w-80 bg-white text-gray-800 m-auto p-2">
          <h3>
            {atom}
            </h3>
         <h2>
           {Object.assign(AT)[atom].image.title}
          </h2>
          <Image
          src={`${Object.assign(AT)[atom].image.url}`}
          alt=""
          width={100}
          height={100}
          className="w-full"
          />
            { Object.assign(AT)[atom].bohr_model_image && <Image
          src={`${Object.assign(AT)[atom].bohr_model_image}`}
          alt=""
          width={100}
          height={100}
          className="w-full"
