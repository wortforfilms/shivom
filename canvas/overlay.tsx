...
function Customizer() {
  const snap = useSnapshot(state)
  const [cn,setCn]=useState<any>(document.querySelector('canvas'))
  ...
  const _snap=()=>{
    if(typeof window !== "undefined"){
      ...
      link.setAttribute('href', cn.toDataURL('image/png').replace('image/png', 'image/octet-stream'))
      link.click()
    }
  ...
  return (
    <div className="customizer">
      ...
      {document.querySelector("canvas") && <button
        className="share"
