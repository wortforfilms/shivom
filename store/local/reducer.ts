...
export type LocalState = {
  currency: { symbol: string, abberivation: string },
  rates:[],
  local_region: string,
  local_pin: [string, string],
...
export const localState: LocalState = {
  currency: { symbol: "₹", abberivation: "INR" },
  rates:[],
  local_region: "",
  local_pin: ["", ""],
  device_ip_address: "",
...
export const localReducer = (state = localState, action: any) => {
  switch (action.type) {
    case SET_CURRENCY:
      return {
        ...state,
    ...
    case SET_CURRENCY_FAILURE:
      ...
      case SET_CURRENCY_RATES_FAILURE:
        return {
          ...state,
          error: action.error,
          loading: false
    ...
    case SET_LOCAL_REGION:
      return {
        ...state,
        loading: true
      }
    case SET_LOCAL_REGION_SUCCESS:
      return {
        ...state,
        local_region: action.local_region,
        local_pin: action.local_pin,
        device_ip_address: action.device_ip_address,
        loading: false
      }
    case SET_LOCAL_REGION_FAILURE:
      return {
        ...state,
        currency: action.error,
        loading: false
      }
      ...
      case SET_LOCAL_CONTACTS_SUCCESS:
        return {
          ...state,
          contacts: action.contacts,
          loading: false
        }
      case SET_LOCAL_CONTACTS_FAILURE:
        return {
          ...state,
          error: action.error,
          loading: false
